export enum Procedure {
    ...
    Message_UpdateEmbed = 'Message_UpdateEmbed',
    Message_UpdateColor = 'Message_UpdateColor',
    ...
    Guild_UpdateDateFormat = 'Guild_UpdateDateFormat',
    ...
    MemberAnniversaryRole_Add = 'MemberAnniversaryRole_Add',
    MemberAnniversaryRole_Clear = 'MemberAnniversaryRole_Clear',
    MemberAnniversaryRole_Get = 'MemberAnniversaryRole_Get',
    MemberAnniversaryRole_GetList = 'MemberAnniversaryRole_GetList',
    MemberAnniversaryRole_Remove = 'MemberAnniversaryRole_Remove',
    ...
    Combined_GetGuildAndUserVote = 'Combined_GetGuildAndUserVote',
}
