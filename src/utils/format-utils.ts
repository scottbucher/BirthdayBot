...
export abstract class FormatUtils {
    ...
    public static async getCustomMessageListEmbed(
        ...
        let embed = new MessageEmbed()
            ...
            .setFooter(`Total Messages: ${customMessageResults.stats.TotalItems}`, guild.iconURL())
            .setTimestamp();
        ...
        let description = `*A random birthday message is chosen for each birthday. If there are none set, it will use the default birthday message.*\n\n`;
    ...
    public static async getBirthdayListFullEmbed(
        ...
        let embed = new MessageEmbed()
            ...
            .setThumbnail(guild.iconURL())
            .setColor(Config.colors.default)
            .setFooter(`Total Birthdays: ${userDataResults.stats.TotalItems}`, guild.iconURL())
            .setTimestamp();
